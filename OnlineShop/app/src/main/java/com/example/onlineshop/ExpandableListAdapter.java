...
public class ExpandableListAdapter extends BaseExpandableListAdapter
{
    ...
    public ExpandableListAdapter(MainActivity context, List<String> listDataHeader,
                             ...
                             boolean isLastChild, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            ...
            convertView = infalInflater.inflate(R.layout.children, parent, false);
        }
                             ...
                             View convertView, ViewGroup parent)
    {
        ...
        if (isExpanded)
        {
            ...
            header_text.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_launcher_foreground, 0,
                    0, 0);
        }
        else
        {
        ...
        // and change the icon
            ...
            header_text.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_launcher_background, 0,
                    0, 0);
        }
